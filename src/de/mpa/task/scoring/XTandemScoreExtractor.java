...
public class XTandemScoreExtractor extends ScoreExtractor {	
	...
	protected void extract() {
		...
		// Remove X!Tandem target file from memory
		xTandemFileTarget = null;
		
		// Next load X!Tandem decoy file into memory.
		if (decoyFile != null) {
			try {
			...
			// Remove X!Tandem decoy file from memory
			xTandemFileDecoy = null;
		}
     ...
     */
    private static String formatSpectrumTitle(String spectrumTitle) {
