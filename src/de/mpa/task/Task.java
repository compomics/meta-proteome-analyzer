...
/**
 * Abstract class of a task to be executed.
 * Implements the interface Executable which provides the specification of a task.
 * @author Thilo Muth
 *
 */
public abstract class Task implements Executable {
     ...
     */
    protected static Logger log = Logger.getLogger(Task.class);
