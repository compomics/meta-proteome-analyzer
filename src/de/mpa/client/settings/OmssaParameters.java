...
public class OmssaParameters extends DbSearchSettings implements ParameterSet {
	...
	public void setDefaults() {
		...
		params.add(new Parameter("Fragment Mass Type", new Object[] { "monoisotopic=0", "average=1", "monoisotopicN15=3" }, List.class, "Spectrum", "Fragment mass type: monoisotopic|average|monoisotopicN15"));
		params.add(new Parameter("Precursor Mass Type", new Object[] { "monoisotopic=0", "average=1", "monoisotopicN15=3" }, List.class, "Spectrum", "Fragment mass type: monoisotopic|average|monoisotopicN15"));
		params.add(new Parameter("Precursor tol / charge scaling", false, Boolean.class, "Spectrum", "Precursor mass tolerance scales according to charge state."));
		params.add(new Parameter("Most Intense Peaks", 6, Integer.class, "Spectrum", "Number of m/z values corresponding to the most intense peaks."));
		params.add(new Parameter("Worker threads", 0, Integer.class, "Spectrum", "The number of threads OMSSA is using for processing."));
		
		// Scoring parameters.
		params.add(new Parameter("<html>Required number<br>of m/z matches per spectrum</html>", 2, Integer.class, "Scoring parameters", "The number of m/z matches a sequence library peptide must have for the hit to the peptide to be recorded."));
		params.add(new Parameter("Maximum number of hits", 30, Integer.class, "Scoring parameters", "Maximum number of hits retained per precursor charge state per spectrum."));
		params.add(new Parameter("Maximum e-value allowed", 1000.00, Double.class, "Scoring parameters", "Maximum e-value allowed in the hit list."));
