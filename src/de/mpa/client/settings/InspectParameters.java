...
public class InspectParameters extends DbSearchSettings implements ParameterSet{
	...
	public void setDefaults() {
		...
		params.add(new Parameter("Maximum PTM Size (Da)", 250,  "Unrestrictive PTM Mode", "For blind search, specifies the maximum modification size (in Da) to consider. Default=250 Da."));
		...
		params.add(new Parameter("Tag Length (1-6)", 3, "Scoring parameters", "Tag length 1-6."));
	}
