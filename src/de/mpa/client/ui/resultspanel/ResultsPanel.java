...
import de.mpa.client.ui.sharedelements.chart.HeatMapPane;
...
public class ResultsPanel extends JPanel implements Busyable {
	 ...
	 */
	public ResultsPanel() {
		this.dbPnl = new DbSearchResultPanel(ontologyData, taxonomyData);
	...
	public void initChartData() {
		this.ontologyData.init();
		this.taxonomyData.init();
	}
	...
	private JPanel createSummaryPanel() {
		...
		fetchResultsBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				expList.add((MPAExperiment) ClientFrame.getInstance().getProjectPanel().getSelectedExperiment());
		...
		if ("".equals(key)) {
			...
			if (proteinHits != null) {
				...
				for (ProteinHit proteinHit : proteinHits) {
					// XXX not applicable anymore
//					if (proteinHit instanceof MetaProteinHit) {
//						MetaProteinHit metaProteinHit = (MetaProteinHit) proteinHit;
//						ArrayList<MetaProteinHit> proteinHitList = metaProteinHit.getProteinHitList();
...
//					}
	...
	private class FetchResultsTask extends SwingWorker<Integer, Object> {
		 ...
		 */
		private final ArrayList<MPAExperiment> experimentList;
		 ...
		 */
		public FetchResultsTask(ArrayList<MPAExperiment> experimentList) {
		...
		protected Integer doInBackground() {
			...
			try {
    			...
    			ArrayList<MPAExperiment> expList = null;
				Client.getInstance().newDatabaseSearchResult(experimentList);
...
//						new ErrorInfo("Severe Error", e.getMessage(), null, null, e, ErrorLevel.SEVERE, null));
	...
	private class ProcessResultsTask extends SwingWorker<Object, Object> {
		...
		protected Object doInBackground() {
			try {
				...
				// process results
				MetaProteinFactory.determineTaxonomyAndCreateMetaProteins(client.getResultParameters());
	...
	private class UpdateOverviewTask extends SwingWorker<Integer, Object> {
		...
		protected Integer doInBackground() {
			...
			DbSearchResult dbSearchResult = Client.getInstance().getDatabaseSearchResult();
