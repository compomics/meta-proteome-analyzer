...
public class PhylogenyTreeTableNode extends SortableCheckBoxTreeTableNode implements Cloneable {
	...
	public Object getValueAt(int column) {
		if (this.userObject instanceof MetaProteinHit) {
			MetaProteinHit ph = (MetaProteinHit) this.userObject;
			switch (column) {
			...
			case 2:
				...
				if (value == null) {
					String sequences = "";
					PeptideHit peptide = psm.getPeptideHit();
	...
	public boolean isSpectrumMatch() {
		return (this.userObject instanceof PeptideSpectrumMatch);
	}
