...
import de.mpa.client.ui.statuspanel.StatusPanel;
import de.mpa.io.ExportHeader;

/**
 * <b> ClientFrame </b>
 * <p>
 * Represents the main graphical user interface for the
 * MetaProteomeAnalyzer-Client.
 * </p>
 * 
...
public class ClientFrame extends JFrame {
	 ...
	 * 
	 * @param viewerMode
	 *            flag indicating whether the client is running in viewer mode.
	...
	/**
	 * Creates the main application frame using the specified viewer and debug
	 * flags.
	 * 
	 * @param viewer
	 *            <code>true</code> if the application is to be launched in
	 *            viewer mode
	 * @param debug
	 *            <code>true</code> if the application is to be launched in
	 *            debug mode
	 ...
	 * @param index
	 *            the tab index
	 * @return <code>true</code> if the tab is enabled, <code>false</code>
	 *         otherwise
	 */
	...
	/**
	 * Convenience method to create a navigation button for cycling tab
	 * selection.
	 * 
	 * @param next
	 *            <code>true</code> if this button shall advance the tab
	 *            selection in ascending index order, <code>false</code>
	 *            otherwise
	 * @param enabled
	 *            <code>true</code> if this button shall be initially disabled,
	...
	public JButton createNavigationButton(boolean next, boolean enabled) {
		...
		button.setFont(button.getFont().deriveFont(Font.BOLD, button.getFont().getSize2D() * 1.25f));
	 ...
	 * 
	 * @param lastSelectedExportHeaders
	 *            The last selected export headers.
	 */
