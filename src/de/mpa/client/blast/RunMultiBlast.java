...
//	}
	 ...
	 * @throws IOException 
	 */
	public static void performBLAST4Experiments(String blastFile, String database, double evalue, long experimentID, BlastDialog.BlastResultOption resultOption) throws SQLException, IOException {
...
//	}
	 ...
	 * @throws SQLException
	 */
	private static void storeBLASTinDB(HashMap<String, BlastResult> resultMapBLAST, double evalue, BlastDialog.BlastResultOption resultOption,
		...
		for (String key : resultMapBLAST.keySet()) {
			...
			UniProtEntryMPA common_ancestor = UniProtUtilities.getCommonUniprotEntry(upEntries, taxonomyMap, TaxonomyUtils.TaxonomyDefinition.COMMON_ANCESTOR);
			...
			for (Long protIDkey : addMultipleUniProtEntriesToDatabase.keySet()) {
				...
				protAcc.setSource("BLAST_" + protAcc.getSource() + "_" + Type.UNIPROTSPROT);
