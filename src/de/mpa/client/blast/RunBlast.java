...
// */
// public static BlastResult blast(String blastFile, String database, double
// evalue, DbEntry dbEntry){
// // Result object
...
// File(Constants.BLAST_DUMMY_FASTA_FILE)));
// // String of the current line.
// bw.write(DB_Type.UNIPROTSPROT.dbStartFlag + dbEntry.getIdentifier());
// // Add subheaders if more than two one entry is available (first is the
// identifier)
