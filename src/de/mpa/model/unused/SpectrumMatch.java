...
/*
 *
 * THIS CLASS IS MARKED FOR DELETION, TODO: REMOVE all references 
 * 
 */
@Deprecated
public abstract class SpectrumMatch implements Serializable, Comparable<SpectrumMatch>, Taxonomic, Hit {
//	
//	/**
...
//	 */
//	// XXX constructor removed to check for use-instances
...
//		// method is used in other deprecated methods and in a compareTo method used for table sorting
//		// method is used in several exporters -> lets see if this is correct
...
//		// XXX this is insane! why is this not a "=="-comparison
//		// however this is only used for sorting purposes
