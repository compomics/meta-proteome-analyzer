...
public class XTandemJob extends Job {
	 ...
	 */
	public XTandemJob(File mgfFile, String searchDB, String params, double fragmentTol, double precursorTol,
		...
		try {
			...
			bw.write("<?xml version=\"1.0\"?>\n"
					...
					+ "\t<note type=\"input\" label=\"spectrum, use noise suppression\">yes</note>\n" + parameters[5] // "\t<note
																														...
																														// parent
																														// m+h\">500.0</note>\n"
					+ parameters[6] // "\t<note type=\"input\" label=\"spectrum,
									// minimum fragment mz\">150.0</note>\n"
					+ parameters[4] // "\t<note type=\"input\" label=\"spectrum,
									// minimum peaks\">15</note> \n"
					+ parameters[7] // "\t<note type=\"input\" label=\"spectrum,
									// threads\">4</note>\n"
					+ parameters[8] // "\t<note type=\"input\" label=\"spectrum,
									// sequence batch size\">1000</note>\n"
					...
					+ parameters[0] // "\t<note type=\"input\" label=\"protein,
									// cleavage site\">[RK]|{P}</note>\n"
					+ parameters[1] // "\t<note type=\"input\" label=\"protein,
									// cleavage semi\">yes</note>\n"
					...
					+ "\t<note type=\"input\" label=\"refine, tic percent\">20</note>\n" + parameters[10] // "\t<note
																											...
																											// spectrum
																											// synthesis\">yes</note>\n"
					+ parameters[11] // "\t<note type=\"input\" label=\"refine,
										// maximum valid expectation
										// value\">0.1</note>\n"
					...
					+ "</note>\n" + parameters[14] // "\t<note type=\"input\"
													// label=\"scoring, x
													// ions\">no</note>\n"
					+ parameters[15] // "\t<note type=\"input\" label=\"scoring,
										// y ions\">yes</note>\n"
					+ parameters[16] // "\t<note type=\"input\" label=\"scoring,
										// z ions\">no</note>\n"
					+ parameters[17] // "\t<note type=\"input\" label=\"scoring,
										// a ions\">no</note>\n"
					+ parameters[18] // "\t<note type=\"input\" label=\"scoring,
										// b ions\">yes</note>\n"
					+ parameters[19] // "\t<note type=\"input\" label=\"scoring,
										// c ions\">no</note>\n"
