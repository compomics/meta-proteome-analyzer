...
import de.mpa.db.mysql.accessor.Pep2prot;
...
//													}
										...
										if (proteinID != null) {
											...
											System.err.println("Protein hit for " + pep_sequence + " not stored");
										}
									}
...
//	}
	...
	public class MascotPeptideHit extends PeptideHit {
		 ...
		 * Protein accessions
		 */
		private ArrayList<String> protAccs;
		 ...
		 */
		public MascotPeptideHit(String pepseq, Double pepscore, ArrayList<String> proteins, Double dmass, Double eval) {
			super(pepseq, 0, 1);
