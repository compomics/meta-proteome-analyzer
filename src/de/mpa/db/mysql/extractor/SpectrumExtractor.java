...
//	 */
//	@Deprecated
//	public Map<Long, String> getSpectrumTitlesFromMatches(List<PeptideSpectrumMatch> matches) throws SQLException {
...
//				if (!res.containsKey(match.getSpectrumID())) {
//					sb.append("searchspectrum.searchspectrumid = " + match.getSpectrumID());
//					sb.append(" OR ");
//					res.put(match.getSpectrumID(), null);
//				}
//			}
